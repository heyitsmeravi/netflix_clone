    ...
    <div className='home'>
      ...
      <div className="hero">
        ...
        <div className="hero-caption">
            <img src={hero_title} className="caption-img" alt="caption-img" />
            <p>Discovreing his treis to a secret ancient order, a young man living in modern Istanbul embark on a quest to save the city from an immortal enemy.</p>
